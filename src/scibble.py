...
tictoc = time.time() - tic
print("Plot1: Voxelizing took {0} for {1} points".format(tictoc, np_pc1.shape[0]))
tic = time.time()
np_vox2 = voxilize(np_pc2)
tictoc = time.time() - tic
print("Plot2: Voxelizing took {0} for {1} points".format(tictoc, np_pc2.shape[0]))
tic = time.time()
np_vox3 = voxilize(np_pc3)
tictoc = time.time() - tic
print("Plot3: Voxelizing took {0} for {1} points".format(tictoc, np_pc3.shape[0]))
