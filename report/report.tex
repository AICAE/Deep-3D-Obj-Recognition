...
The files were provided in Matlab format (.mat files) a single file for each model.
...
=======
ModelNet40 contains 151,128 3D models, ModelNet10 a subset with 10 categories, which is augmented by 12 rotations.
Our training process takes around 9 to 20 hours on a NVIDIA GTX 980TI (6GB) GPU depending on the choice of the dataset (ModelNet10/40).
During training, improved weights are saved to ensure efficiency when training crashes. \textbf{TODO: Mehr \& Warum?} \\ 
>>>>>>> Stashed changes
